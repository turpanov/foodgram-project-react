...
SECRET_KEY = '0_2stk=-7bypvy$b=(+112zjoskwp5!#3_=g+z7=qmj15d01qa'
...
DATABASES = {
    'default': {
        ...
        #  
        #  Данные настройки подготовлены для дальнейшего перехода на PostgreSQL.
        #  Разработка велась на SQLite
        #
